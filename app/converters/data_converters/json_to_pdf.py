...
from app.converters.data_converters.shared import load_json_dataframe, dataframe_to_pdf


class JsonToPdfConverter(BaseConverter):
    """JSON to a paginated PDF table; switches to landscape for wide datasets."""
